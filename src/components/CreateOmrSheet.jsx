...
const CreateOmrSheet = ({ examName, paperName, paperCode, totalQuestions,type }) => {
...
const renderRollNo = () => {
  ...
  return (
    <div>
      <div className="download-btn" style={{ display: "none" }}>
        <button onClick={exportPDF}>Download OMR PDF</button>
        <button onClick={exportPNG} style={{ marginLeft: "10px" }}>Download OMR PNG</button>
      </div>

      <div ref={sheetRef} className="omr-sheet" style={{ position: "absolute", left: "-9999px", top: 0 }}>
        {/* Alignment Markers */}
